    ...
    <div id="main" class="layout-column flex">
        ...
        <div id="content" class="flex">
            <!-- ############ Main START-->
            <div class="card-header" style="text-align: center; text-transform: uppercase; font-size: 26px;margin-top: 20px;"><strong>Add GALLERY</strong></div>
                                    ...
                                    <div class="card-body">
                                        <form action="<?=  base_url('admin/add_dest')?>" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="serv"  placeholder="Enter service"></div>
                                            <div class="form-group">
